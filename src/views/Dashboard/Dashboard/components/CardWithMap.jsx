...
const CardWithBackground = ({ polygon, zoom, center, backgroundImage }) => {
  ...
  // Default polygon for display when no polygon is provided
  ...
  const displayPolygon = polygon && polygon.length > 0 ? polygon : defaultPolygon;
